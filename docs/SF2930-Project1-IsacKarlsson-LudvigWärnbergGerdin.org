...
** Transformations of variables
   ...
   Figure [[fig:boxcox_fit]] pdisplays the values of $\lambda$ to be used in a potential Box-Cox transformation of 
...
** Diagnostics and handling of Outliers
   ...
   We present the five most frequently occuring points in the outlier/influence plots in Table \ref{tab}
...
\newpage
* Discussion
  Note that the \texttt{weight} predictor is included in this model. In section [[Diagnostics and Handling of Multicolinearity]]
